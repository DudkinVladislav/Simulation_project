...
class NETWORK_API Network : public Model {


public:

    Network();
    explicit  Network(const std::string& model_name);
    explicit Network(const std::string& model_name, const std::string& model_class);
    ~Network() override;
