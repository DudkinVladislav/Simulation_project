...
class AVERAGE_MESSAGES_API Average_number_transfered_messages : public Metric {


public:

    Average_number_transfered_messages();
    explicit Average_number_transfered_messages(const std::string& metric_name, const std::string& metric_type);
    ~Average_number_transfered_messages() override;
